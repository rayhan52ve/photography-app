            ...
            <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
                <div class="mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                        <h5 class="mdl-card__title-text text-color--white">Edit Banner Image</h5>
                    </div>
                                ...
                                <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--4-col-phone">
                                    <label class="image" for="imageInput">
                                        <input type="file" id="imageInput" value="{{ old('photo') }}" name="photo"
                                            class="form-control">
                                        @if (@$hero->photo)
                                            <img id="profileImage" src="{{ asset('uploads/hero/' . $hero->photo) }}"
                                ...
                                <div
                                    ...
                                    <div class="row">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                            <input name="title" class="mdl-textfield__input" type="text" value="{{$hero->title}}"
                                                id="floating-first-name">
                                            <label class="mdl-textfield__label" for="floating-first-name">
                                                Title</label>
                                        </div>
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                            <input name="sub_title" class="mdl-textfield__input" type="text"
                                                value="{{$hero->sub_title}}" id="floating-first-name">
                                            <label class="mdl-textfield__label" for="floating-first-name">
                                                Sub Title</label>
                                        </div>
