            ...
            <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
                <div class="mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                        <h5 class="mdl-card__title-text text-color--white">Edit Album</h5>
                    </div>
                                ...
                                <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--4-col-phone">
                                    <label class="image" for="imageInput">
                                        <input type="file" id="imageInput" value="{{ old('photo') }}" name="photo"
                                            class="form-control">
                                        @if (@$album->photo)
                                            <img id="profileImage" src="{{ asset('uploads/album/' . $album->photo) }}"
                                ...
                                <div
                                    ...
                                    <div class="row">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                            <input name="name" class="mdl-textfield__input" type="text" value="{{$album->name}}"
                                        ...
                                        <div
                                            ...
                                            <select name="category_id" class="mdl-textfield__input" id="floating-category">
                                                <option value="" disabled selected>Select Category</option>
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}" {{ $category->id == $album->category_id ? 'selected' : '' }}>
                                                        {{ $category->name }}
                                                    </option>
                                                @endforeach
                                            </select>
