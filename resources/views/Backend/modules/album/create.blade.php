            ...
            <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
                <div class="mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                        <h5 class="mdl-card__title-text text-color--white">Create New Banner Image</h5>
                    </div>
                                ...
                                <div
                                    ...
                                    <div class="row">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                            <input name="name" class="mdl-textfield__input" type="text" value=""
                                        ...
                                        <div
                                            ...
                                            <select name="category_id" class="mdl-textfield__input" id="floating-category">
                                                ...
                                                @empty
                                                    <option disabled>No Category Created Yet.</option>
                                                @endforelse
