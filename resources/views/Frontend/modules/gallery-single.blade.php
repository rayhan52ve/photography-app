            ...
            <div class="position-relative h-100">
                <div class="slides-1 portfolio-details-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        ...
                        <div class="swiper-slide">
                            <img src="{{asset('frontend/assets/img/gallery/gallery-9.jpg')}}" alt="">
                        </div>
                        <div class="swiper-slide">
                            <img src="{{asset('frontend/assets/img/gallery/gallery-10.jpg')}}" alt="">
                        </div>
                        <div class="swiper-slide">
                            <img src="{{asset('frontend/assets/img/gallery/gallery-11.jpg')}}" alt="">
                        </div>
                        <div class="swiper-slide">
                            <img src="{{asset('frontend/assets/img/gallery/gallery-12.jpg')}}" alt="">
                        </div>
                        <div class="swiper-slide">
                            <img src="{{asset('frontend/assets/img/gallery/gallery-13.jpg')}}" alt="">
                        </div>
